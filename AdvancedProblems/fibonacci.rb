...
# whose first and second elements are 1. To generate
# further elements of the sequence we take the sum of
# the previous two elements. For example the first 6 f
